...
def get_contact(id):
    ...
    используя его уникальный идентификатор. Если контакт найден, возвращается страница с информацией о нем.
    ---
    parameters:
      - name: id
        type: integer
...
def delete_contact(id):
    ...
    Если контакт с указанным идентификатором существует, он будет удален, и вернетс. 
